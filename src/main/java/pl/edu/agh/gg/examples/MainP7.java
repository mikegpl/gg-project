...
public class MainP7 {
    ...
    private static GraphModel generateGraphModel() {
        GraphModel graphModel = new GraphModel("P7");
        ...
        GraphNode e24 = graphModel.insertGraphNode(new ENode(graphModel, "e24", new Coordinates(1, 0, 0)));
        ...
        graphModel.insertGraphEdge("e2e24", e2, e24);

        graphModel.insertGraphEdge("e13e3", e13, e3);
        graphModel.insertGraphEdge("e24e4", e24, e4);
